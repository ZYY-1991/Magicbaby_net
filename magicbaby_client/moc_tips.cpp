...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_tips_t, stringdata) + ofs \
...
const QMetaObject tips::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_tips.data,
      qt_meta_data_tips,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *tips::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tips.stringdata))
        return static_cast<void*>(const_cast< tips*>(this));
